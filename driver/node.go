...
func (s *NodeService) NodeStageVolume(ctx context.Context, req *proto.NodeStageVolumeRequest) (*proto.NodeStageVolumeResponse, error) {
	...
	case *proto.VolumeCapability_Block:
		return &proto.NodeStageVolumeResponse{}, nil
	case *proto.VolumeCapability_Mount:
		opts := volumes.NewMountOpts()
		if accessType.Mount.FsType != "" {
			opts.FSType = accessType.Mount.FsType
		}
		opts.Additional = accessType.Mount.MountFlags
...
func (s *NodeService) NodePublishVolume(ctx context.Context, req *proto.NodePublishVolumeRequest) (*proto.NodePublishVolumeResponse, error) {
	...
	switch accessType := req.GetVolumeCapability().GetAccessType().(type) {
	case *proto.VolumeCapability_Block:
		if err := s.volumeMountService.PublishBlock(volume, req.GetTargetPath(), opts); err != nil {
			return nil, err
		}
	...
	case *proto.VolumeCapability_Mount:
		...
		if err := s.volumeMountService.PublishFilesystem(volume, req.TargetPath, req.StagingTargetPath, opts); err != nil {
